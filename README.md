...
├── collector/           The collector (Rust): holds one OIDC grant for the owner's own mailbox and calendars, publishes a mail received and a change in the calendars, says what state each connection is in
