//! Windows time-zone names, and the IANA zone each one means.
//!
//! Generated, not written: see `collector/tools/generate-windows-zones.py`.
//!
//! - source: CLDR `release-47`, `common/supplemental/windowsZones.xml`
//! - the file's own versions: `otherVersion="7e11800"`, `typeVersion="2021a"`
//! - rows: the `territory="001"` ones, 139 of them — the row CLDR uses
