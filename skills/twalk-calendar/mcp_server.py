...
TOOLS = [
    {
        ...
        "description": (
            ...
            "they were local hours. Prefer a gap of a decent `minutes`, inside "
            "the hours a person works — a gap at 03:00 is free and is not an "
            "offer. The answer also carries `timezone`, `timezone_source` and "
