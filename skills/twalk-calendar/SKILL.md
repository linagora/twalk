...
3. Propose **up to three** slots inside working hours that fall entirely in gaps, leaving a margin around busy intervals. Never propose a slot that overlaps one.
4. **Up to three means fewer when there are fewer.** A contact who asked for three has asked for three times, not for three sentences: if the week holds one decent slot, offer that one and say the week is full — *"je n'ai que jeudi 12h30 cette semaine-là, sinon la suivante"*. Measured on 2026-09-24: asked for three, an agent with one good gap filled the other two with 8:00 and 19:30 on a Friday. Both were genuinely free and neither is a time a person offers a colleague.
5. Say nothing about *why* the owner is busy — you do not know, and the answer does not carry it. "Thursday morning is taken" is right; "Thursday morning she has a meeting" is a guess.
6. If the window you need is wider than fourteen days, ask about the nearest fortnight first.
