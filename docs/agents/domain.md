...
- **`docs/architecture/adr/`**: the ADRs. Read the ones touching the area you are about to work in. (Note the path — decisions live under `docs/architecture/adr/`, not `docs/adr/`. ADRs 0005–0025 are written; 0001–0004 are referenced from the README and the wireframes but not yet written, and their numbers are reserved.)
