...
| `clerk-deployment` | advisory | 47–61 s, 2 tests | small | — | **warm images** (the Gateway's and the clerk's), the clerk test relay warm; needs passwordless `sudo` on the runner (#284) |
